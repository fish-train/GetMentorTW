...
1. Составьте карту текущих компетенций. 
   Выпишите все ваши навыки, оцените текущий уровень владения ими. Подумайте, что из этого вы хотели бы подтянуть.
   Примеры:
...
2. Дополните карту новыми компетенциями, которыми вы пока не владеете:
   ...
   A. Проанализируйте вашу текущую профессиональную деятельность и перспективы развития. Хватает компетенций, чтобы выполнять свою работу быстрее и качественнее? Отсутствие каких-то знаний мешает продвигаться по карьерной лестнице? Можно предложить план развития для повышения зп на текущей работе. Добавьте это в карту компетенций.
   B. Найдите несколько интересных вакансий, которые вам нравятся. Изучите их требования — есть ли там что-то, что вы не умеете и не знаете? Добавьте это в карту компетенций.
   C. Подумайте, что вы бы сами хотели изучить, каким умениям хотели бы научиться? Добавьте это в карту компетенций.
